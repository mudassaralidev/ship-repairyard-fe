...
export const fetchInventories =
  ...
  async (dispatch) => {
    ...
    try {
      const data = await fetchInventoriesApi({ shipyardId, queryParams });
...
export const createNewInventory =
  (shipyardID, inventoryData) => async (dispatch) => {
    try {
...
export const updateExistingInventory =
  (shipyardID, inventoryID, updates) => async (dispatch) => {
    try {
      const updatedInventory = await updateInventoryApi(
        shipyardID,
        inventoryID,
        updates,
      );
